...
public class TC_TodaysDeals extends BaseClass {
	AmazonPage page;

	public TC_TodaysDeals() {
	...
	public void AutomationCheck(Hashtable<String, String> data) throws Exception {
		if (!data.get("RunMode").equalsIgnoreCase("N")) {
			node = test.createNode(data.get("TestName"));
			node.assignDevice(data.get("windows")+"__"+data.get("browser"));
			//node.assignDevice(data.get("windows") + "__" + data.get("browser"));
			page = new AmazonPage(Constants.AmazonRepository, node);
	...
	@Test(dataProvider = "getWebData")
	public void Electronics(Hashtable<String, String> data) throws Exception {
		if (!data.get("RunMode").equalsIgnoreCase("N")) {
			node = test.createNode(data.get("TestName"));
			node.assignDevice(data.get("windows")+"__"+data.get("browser"));
			//node.assignDevice(data.get("windows") + "__" + data.get("browser"));
