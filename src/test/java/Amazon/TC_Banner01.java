...
public class TC_Banner01 extends BaseClass {
	...
	public void LoginCheck(Hashtable<String, String> data) throws Exception {
		if (!data.get("RunMode").equalsIgnoreCase("N")) {
			...
			page.setBrowserStackCap(data, "Badger").launchInstance(data.get("browser"));
			page.openApplication(data.get("Url"));
			page.clickNextBanner();
			page.countOfBanners();
